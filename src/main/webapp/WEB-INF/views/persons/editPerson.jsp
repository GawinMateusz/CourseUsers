                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input name="firstName" class="form-control" type="text" value="${person.firstName}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Nazwisko</label>
                                        <div class="col-10">
                                            <input name="lastName" class="form-control" type="text" value="${person.lastName}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input name="gitHub" class="form-control" type="text" value="${person.gitHub}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <textarea name="start" class="form-control" rows="5">${person.start}</textarea>
                                        </div>
                                    </div>
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="col-1">
                                       <label class="radio-inline"><input name="checkbox" type="radio" name="checkbox" value="0" checked>NIE</label>
                                       </div>
                                    </div>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                            ...
                            <label class="col-form-label">Java</label>
                                <input name="java" class="form-control" type="text" value="${person.java}">
                             </div>


                            <div class="col-2">
                             <label class="col-form-label">Wzorce projektowe</label>
                             <input name="bestpractice" class="form-control" type="text" value="${person.bestpractice}">
                             </div>


                            <div class="col-2">
                            <label class="col-form-label">TDD</label>
                                <input name="tdd" class="form-control" type="text" value="${person.tdd}">
                            </div>


                        <div class="col-2">
                         <label class="col-form-label">Bazy danych SQL</label>
                             <input name="question" class="form-control" type="text" value="${person.question}">
                             </div>
                            ...
                            <label class="col-form-label">Hibernate JPA</label>
                                <input name="hibernate" class="form-control" type="text" value="${person.hibernate}">
                            </div>


                            <div class="col-2">
                            <label class="col-form-label">HTML_CSS</label>
                             <input name="html" class="form-control" type="text" value="${person.html}">
                             </div>


                            <div class="col-2">
                            <label class="col-form-label">JSP</label>
                                <input name="jsp" class="form-control" type="text" value="${person.jsp}">
                            </div>

                           <div class="col-2">
                            <label class="col-form-label">Thymeleaf</label>
                                <input  name="thymeleaf" class="form-control" type="text" value="${person.thymeleaf}">
                            </div>

                            <div class="col-2">
                            <label class="col-form-label">git</label>
                                <input name="git" class="form-control" type="text" value="${person.git}">
                            </div>
