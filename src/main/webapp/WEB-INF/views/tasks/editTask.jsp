    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form method="post" action='<c:url value="/editTaskSave/${task.id}"/>'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <select class="form-control" id="person.id" name="person.id">
                                            <option hidden>${task.person.firstName} ${task.person.lastName}</option>
                                            <c:forEach items="${person}" var="name">
...
<%--                                       name="startDate">--%>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea class="form-control" rows="5" id="start" name="description" >${task.description}</textarea>
                                    </div>
                                </div>
                ...
                <input class="btn btn-danger pull-left" type="submit" value="Usuń" id="deleteButton"></input>
                </form>
