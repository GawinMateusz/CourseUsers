...
<div id="wrapper">
 ...
 <div class="col-lg-12">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="card mb-4 py-3 ${title.color}">
                        <div class="card-body">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">${title.person.firstName} ${title.person.lastName}
                                | <strong>Dodano:</strong> ${title.startDate} | <strong>Deadline:</strong> ${title.deadline}</div>
                        ${title.description}
                        </div>
                    </div>
                        </a>
